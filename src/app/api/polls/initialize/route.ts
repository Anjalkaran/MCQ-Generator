...
// The vote counts are all zero. This will only be used if the poll doesn't exist.
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        if (!pollSnap.exists) {
            ...
            return NextResponse.json({ status: 'success', message: 'Poll initialized successfully.' });
        }
