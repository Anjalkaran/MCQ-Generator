      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="flex flex-col">
          <CardHeader>
            ...
            <CardDescription className="pt-4">
              Practice with image-based reasoning questions to sharpen your analytical and non-verbal skills.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex-grow flex items-end">
            <Button asChild className="w-full">
              <Link href="/dashboard/reasoning-test">Start Reasoning Test</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
