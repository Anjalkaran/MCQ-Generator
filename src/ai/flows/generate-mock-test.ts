...
const generateMockTestFlow = ai.defineFlow(
  ...
  async input => {
    ...
    // 1. Collect all unique topic IDs needed from the blueprint first.
    ...
    // 4. Create a map of topicId -> MCQ[] for easy access
